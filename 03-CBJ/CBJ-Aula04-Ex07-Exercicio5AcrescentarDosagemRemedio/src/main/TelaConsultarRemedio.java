 ...
 * @author Aluno
 */
public class TelaConsultarRemedio extends javax.swing.JFrame {

    /**
     * Creates new form TelaCadastroRemedio
     */
    public TelaConsultarRemedio() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("CONSULTAR REMEDIO");
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        r1.id = Integer.valueOf(txtId.getText());
         ...
         try {
            r1 = rd1.consultar(r1.id);
            txtNome.setText(r1.nome);
            txtDosagem.setText(String.valueOf(r1.dosagem));
    ...
    public static void pacoca(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaConsultarRemedio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaConsultarRemedio().setVisible(true);
            }
        });
    }
