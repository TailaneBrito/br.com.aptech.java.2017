...
public class TelaCadastroVendedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("CADASTRAR NOVO VENDEDOR");
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        VendedorDAO vd1 = new VendedorDAO();
        v1.nome = txtNome.getText();
        v1.salario = Integer.parseInt(txtSalario.getText());
        v1.regiao = txtRegiao.getText();
        
        try {
            vd1.cadastrarNovoVendedor(v1);
