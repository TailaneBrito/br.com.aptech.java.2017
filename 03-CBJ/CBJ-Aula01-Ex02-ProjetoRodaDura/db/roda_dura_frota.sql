...
CREATE TABLE `frota` (
  ...
  `ano_carro` int(11) DEFAULT NULL,
  `combustivel_carro` varchar(45) DEFAULT NULL,
  `fabricante_carro` varchar(45) DEFAULT NULL,
...
INSERT INTO `frota` VALUES (1,'Gol',2006,'Alcool','Volkswagem'),(2,'Civic',2006,'Gasolina','Honda'),(3,'Meriva',2006,'Gasolina','Chevrolet'),(4,'Fiesta',2013,'Alcool','Ford'),(5,'Fit',2012,'Alcool','Honda');
